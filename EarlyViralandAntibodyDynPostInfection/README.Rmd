...
This folder includes:
1.  **Julia codes for identifiability analysis**. Original Julia code (.jl files) developed to analysis the structural identifiability of the joint model and results obtained (.txt file). Results were obtained with Julia 1.11.3.
